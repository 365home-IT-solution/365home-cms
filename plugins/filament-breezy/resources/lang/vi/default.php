...
return [
    ...
    'profile' => [
        ...
        '2fa' => [
            ...
            'disabling' => [
                'notify' => 'Xác thực hai yếu tố đã bị vô hiệu hóa.',
            ],
            'confirmation' => [
        ...
        'sanctum' => [
            ...
            'create' => [
                ...
                'message' => 'Mã token của bạn chỉ được hiển thị một lần khi tạo. Nếu bạn mất mã token của mình, bạn sẽ cần phải xóa nó và tạo một mã mới.',
                'submit' => [
                    'label' => 'Tạo',
                ],
            ],
            ...
            'copied' => [
                'label' => 'Tôi đã sao chép mã token của mình',
            ],
        ],
    ],
    'clipboard' => [
