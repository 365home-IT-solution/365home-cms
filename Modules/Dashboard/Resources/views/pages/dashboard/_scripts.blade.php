...
window.rcOrderItemClick = function(event, item) {
    ...
    window.location.href = '/homestay/admin/orders/' + orderData.order_id + '/edit';
};
            ...
            html +=
                '<div class="ta-rc-order-item' + (o.is_new ? ' is-new' : '') + ' seg-' + seg + '" data-segment="' + seg + '" data-status="' + o.status + '" data-order="' + _oAttr + '" onclick="rcOrderItemClick(event, this)">' +
                  ...
                  '<div class="ta-rc-line2">' +
                    ...
                    amtHtml +
                    '<a href="/homestay/admin/orders/' + o.order_id + '/edit" class="ta-rc-detail-compact" title="Xem chi tiết đơn"><svg width="13" height="13" viewBox="0 0 24 24" fill="none"><path d="M9 6l6 6-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></a>' +
                  '</div>' +
                '</div>';
        });
                ...
                '<div class="ta-rc-order-item' + (o.is_new ? ' is-new' : '') + ' seg-' + seg + '" data-segment="' + seg + '" data-status="' + o.status + '" data-order="' + _oAttr + '" onclick="rcOrderItemClick(event, this)">' +
                  ...
                  '<div class="ta-rc-order-footer">' +
                    ...
                    '<div style="display:flex;align-items:center;gap:5px;">' +
                      ...
                      '<a href="/homestay/admin/orders/' + o.order_id + '/edit" class="ta-rc-btn-detail"><svg width="11" height="11" viewBox="0 0 24 24" fill="none"><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" stroke="currentColor" stroke-width="2"/><path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" stroke="currentColor" stroke-width="2"/></svg>Chi tiết</a>' +
                    '</div>' +
                  '</div>' +
                '</div>';
        });
    ...
    function renderCustList(d) {
        ...
        el.innerHTML = customers.map(function(c, i) {
            ...
            return '<div class="ta-rr-tr ta-cust-tr">' +
                ...
                '<div class="ta-rr-num">' +
                    '<a href="/homestay/admin/coupons/create" target="_blank" class="ta-cust-coupon-btn" title="Tạo mã khuyến mãi cho ' + c.phone + '">' + COUPON_ICO + '</a>' +
                '</div>' +
            '</div>';
        }).join('');
    }
