            ...
            <div class="ta-rc-orders">
                ...
                <div class="ta-rc-order-item {{ $order['is_new'] ? 'is-new' : '' }} seg-{{ $order['segment'] }}"
                    ...
                    <div class="ta-rc-line2">
                        ...
                        @endif
                        <a href="/homestay/admin/orders/{{ $order['order_id'] }}/edit" class="ta-rc-detail-compact" title="Xem chi tiết đơn">
                ...
                <div class="ta-rc-order-item {{ $order['is_new'] ? 'is-new' : '' }} seg-{{ $order['segment'] }}"
                    ...
                    <div class="ta-rc-order-footer">
                        ...
                        <div style="display:flex;align-items:center;gap:5px;">
                            ...
                            <a href="/homestay/admin/orders/{{ $order['order_id'] }}/edit" class="ta-rc-btn-detail">
