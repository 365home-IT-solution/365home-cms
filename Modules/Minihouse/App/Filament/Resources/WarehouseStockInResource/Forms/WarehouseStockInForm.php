...
namespace Modules\Minihouse\App\Filament\Resources\WarehouseStockInResource\Forms;
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Section::make('Thông tin phiếu')
                ...
                ->compact()
                ->visible(fn (string $operation) => $operation === 'edit' || count(ActiveBuildingScope::permittedBuildingIds()) > 1),
