...
namespace Modules\Minihouse\App\Exports;
...
class WarehouseStockInExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    ...
    {
        return $this->query
            ->with(['creator:id,fullname,email', 'building:id,name'])
            ->withCount('items')
    ...
    {
        $headings = [
            'Mã phiếu', 'Ngày nhập', 'Số dòng hàng', 'Tổng tiền', 'Người nhập', 'Ghi chú', 'Toà nhà',
        ];
