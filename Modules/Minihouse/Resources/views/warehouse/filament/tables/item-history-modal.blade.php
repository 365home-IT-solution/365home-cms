                    ...
                    <tr>
                        ...
                        <td class="py-2 pe-3">
                            <x-filament::badge :color="$typeColor">
                                {{ \Modules\Minihouse\App\Models\WarehouseStockMovement::TYPE_LABELS[$movement->type] ?? $movement->type }}
                            </x-filament::badge>
                        </td>
                        ...
                        <td class="py-2 pe-3 text-gray-700 dark:text-gray-300">
                            {{ \Modules\Minihouse\App\Filament\Support\CurrentUserDisplay::forUser($movement->creator) }}
                        </td>
