...
// Tách riêng từ ManualLockPasswordResource\Pages\ListManualLockPasswords::importAction() (page
// header action, class Filament\Actions\Action — chỉ dùng được ở trang) để dùng lại được ở CẢ
// headerActions() của Table (class Filament\Tables\Actions\Action — dùng trong
// App\Filament\Widgets\ManualLockPasswordTableWidget, trang gộp "Khóa cổng"). Logic import thực sự
// (ManualLockPasswordExcelImport) vẫn dùng chung, không lặp lại ở đây.
class ManualLockPasswordImportAction
{
