                    ...
                    @unless ($isAuthPage)
                        ...
                        <div class="flex items-center justify-center gap-1"
                            ...
                            <button type="button"
                                ...
                                <img src="{{ asset('images/hourglass-40.webp') }}" alt="" class="w-4 h-4 object-contain" width="16" height="16">
                                Theo giờ
                            </button>
                            <button type="button"
                                ...
                                <img src="{{ asset('images/night-time-40.webp') }}" alt="" class="w-4 h-4 object-contain" width="16" height="16">
                                Qua đêm
                            </button>
                            <button type="button"
                                ...
                                <img src="{{ asset('images/building-176.webp') }}" alt="" class="w-4 h-4 object-contain" width="16" height="16">
                                Theo ngày
                            </button>
                        </div>
                    @endunless
