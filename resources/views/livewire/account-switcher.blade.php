...
>
    ...
    @else
        ...
        {{-- Teleport ra <body> — .fi-topbar có class overflow-x-clip, dropdown pop lên ngoài
             khung topbar sẽ bị cắt mất phần dưới nếu render ngay bên trong (đã xác nhận thực tế). --}}
